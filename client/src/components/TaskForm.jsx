...
export default function TaskForm({ onSubmit, onCancel, initialValues, mode = "create" }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="task-name" className="block text-sm font-semibold text-gray-700 mb-1">
          Task Name
        </label>
        <input
          id="task-name"
      ...
      <div className="flex justify-end space-x-2 pt-2">
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded shadow transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
